...
<body>
	<jsp:useBean id="order" class="r4f.model.Order" scope="request">
	</jsp:useBean>
		<jsp:useBean id="orderList" type="java.util.ArrayList<r4f.model.Article>" class="java.util.ArrayList" scope="request">
	</jsp:useBean>
