...
<%@ include file="Header.jspf" %>
	...
	<div id="container">
		...
		<p class="agb">Haben Sie eine Frage, eine gute Idee oder m&ouml;chten Sie uns einfach Ihre Meinung mitteilen?<br/>
		Dann nutzen Sie bitte das unten stehende Formular, um uns Ihre Meinung mitzuteilen. Wir werden Ihnen sobald wie m&ouml;glich antworten.<br/>
		Die h&auml;ufigsten Fragen und Antworten finden sie au&szlig;erdem in unseren FAQ's.</p>
